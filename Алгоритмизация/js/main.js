...
window.onload = function () {
    ...
    const SCENE = [
        //sur.ellipticcylinder(10,"#00ff00"),
        //sur.hyperboliccylinder(10,"#FF0000"),
        //sur.paraboliccylinder(10,"#FF0000"),
        //sur.ellipticparaboloid(30),
        //sur.saturn(20, 5, 10,new Point(-Math.sqrt(6400 - 32 * 32), -32, 0), '#00ff00'),
        //sur.cylinder(point = new Point(0, 0, 0), color = '#00FF00', size = 3, h = 5, count = 20),
        //sur.bublik(size1 = 5, size2 = 9, size3 = 3, point = new Point(0, 0, 0), color = "#00FF00", xy = 1, animation, count = 20, count2 = 15),
        //sur.hyperbolicparaboloid(20),
        //sur.konus(),
        //sur.doublehyperboloid(point = new Point(), h = 2, width = 2, coeff = 1, count = 20, color = "#00FF00"),
        //sur.singlehyperboloid(point = new Point(0,0,0), size1 = 4, size2 = 2, h = 7, color = "#00ff00", count = 20),
        sur.ellipsoid(count = 40, color = '#00ff00'),
